    ...
    <x-app-layout>
        ...
        <div class="card" style="height: auto !important">
          <div class="avatar-picture d-flex">
            {{-- <div class="Post d-flex align-item-start ms-3">
              ...
              <div class="name">
                <div class="m-4 d-flex d-inline-flex justify-content-center">
                <img src="{{ asset('storage/' . (Auth::user()->profile->images ?? "../img/profile-default.webp")) }}" class="rounded-circle" alt="" width="37" height="37" alt="">
      ...
      <!-- card end -->
      <script src="{{ asset('import/asset/js/bootstrap.bundle.min.js') }}" integrity="sha384-geWF76RCwLtnZ8qwWowPQNguL3RmwHVBC9FhGdlKrxdiJJigb/j/68SIy3Te4Bkz" crossorigin="anonymous"></script>
      <script>
